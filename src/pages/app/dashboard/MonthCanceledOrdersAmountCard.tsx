        ...
        {monthCanceledOrdersAmount && (
          ...
          <p className="text-xs text-muted-foreground">
            {monthCanceledOrdersAmount.diffFromLastMonth < 0 ? (
              <>
                <span className="text-emerald-600 dark:text-emerald-400">{monthCanceledOrdersAmount.diffFromLastMonth}%</span>  em relação ao mês passado
              </>
            ) : (
              <>
                <span className="text-rose-600 dark:text-rose-400">+{monthCanceledOrdersAmount.diffFromLastMonth}%</span> em relação ao mês passado
              </>
            )}
          </p>
          </> 
